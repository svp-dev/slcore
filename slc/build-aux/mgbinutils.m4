...
[dnl
 ...
 AC_ARG_VAR([RANLIB_MTSPARC], [Location of the `ranlib' utility configured for the SPARC binary format.])
 AC_PATH_PROG([RANLIB_MTSPARC], [mtsparc-linux-gnu-ranlib], [no], [$prefix/bin$PATH_SEPARATOR$PATH])
 
 AC_ARG_VAR([AR_LEON2MT], [Location of the `ar' utility configured for the MT-Sparc binary format.])
 AC_PATH_PROG([AR_LEON2MT], [sparc-linux-gnu-ar], [no], [$prefix/bin$PATH_SEPARATOR$PATH])

 AC_ARG_VAR([RANLIB_LEON2MT], [Location of the `ranlib' utility configured for the SPARC binary format.])
 AC_PATH_PROG([RANLIB_LEON2MT], [sparc-linux-gnu-ranlib], [no], [$prefix/bin$PATH_SEPARATOR$PATH])
